...
class CatalogTimeoutError(Exception):
    """Raised when catalog API request times out."""
    pass


class CatalogResponseError(Exception):
    """Raised when catalog API returns error HTTP status."""
    pass


class CatalogClient:
    """Client for external catalog API."""
    ...
    def fetch_product(self, product_id: int) -> dict:
        """Fetch product data from catalog API."""
